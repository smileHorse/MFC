...
// DriveTreeDoc.cpp : CDriveTreeDoc 类的实现
//
...
// 缩略图的支持
void CDriveTreeDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CDriveTreeDoc::InitializeSearchContent()
{
...
void CDriveTreeDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
