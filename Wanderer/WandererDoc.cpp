...
// WandererDoc.cpp : CWandererDoc 类的实现
//
...
// 缩略图的支持
void CWandererDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CWandererDoc::InitializeSearchContent()
{
...
void CWandererDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
