...
// EZPrintDoc.cpp : CEZPrintDoc 类的实现
//
...
// 缩略图的支持
void CEZPrintDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CEZPrintDoc::InitializeSearchContent()
{
...
void CEZPrintDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
